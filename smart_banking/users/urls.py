...
from .views import  ChangePasswordView, CreateUserView, CurrencyConversionView, LoginView, UserInfoView, CheckBalanceView,DepositView,WithdrawView,AccountStatementView, chat, chat_history
